...
const ExcelUploader: FC<ExcelUploaderType> = ({ uploaded, setUploaded, deleteUploadedFile, handleUpload, deleteAllUploaded, previewWorkbook }) => {
		...
		<>
			<div id="file-uploader" className="bg-body-secondary border rounded mx-auto position-relative">
				<input
					...
					multiple
					accept=".xls, .xlsx"
					onChange={cacheFiles(langOption, uploaded, setUploaded, msgMaker)}
