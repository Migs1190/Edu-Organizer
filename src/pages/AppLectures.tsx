...
import type { Day, Week, lecturesTableType } from "../components/lectures/worksheetProcessor";
...
const AppLectures = () => {
 ...
 const [week, setWeek] = useState<Week>("odd");
 ...
 const checkEmptySheet = () => {
  ...
  return (
   <div ref={lecturesSection}>
    <DashboardFilter LecWorksheet={LecWorksheet} setDay={setDay} setWeek={setWeek} setClassroom={setClassroom} />
    <LectureDashboard LecWorksheet={LecWorksheet} day={day} week={week} classroom={classroom} />
   </div>
  );
 };
 /* #endregion */
